...
public class AddAccount extends javax.swing.JFrame {
    ...
    public AddAccount() {
        super("Create Employee New Account");
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("G:\\Database Lab(3104)\\Project\\Icon\\clear.png")); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon("G:\\Database Lab(3104)\\Project\\Icon\\createaccount.png")); // NOI18N
        ...
        setSize(new java.awt.Dimension(636, 339));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String sql="INSERT INTO EMPLOYEE_ACCOUNT(Emp_AccID,Emp_Balance) values(?,?)";
        try{
            
            pst=conn.prepareStatement(sql);
            pst.setString(1,jTextField1.getText());//Employee ID
            pst.setString(2,jTextField2.getText());//Balance
            
            pst.execute();
            JOptionPane.showMessageDialog(null, "Congratulation!\nEmployee Account has been Added");
            
        }catch(Exception ex)
        {
            JOptionPane.showMessageDialog(null,"Already have an account");
            System.out.println("CERATE EMPLOYEE ACCOUNT ERROR: "+ex);
        }
