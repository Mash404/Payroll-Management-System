...
public class ProjectList extends javax.swing.JFrame {
    ...
    //CORPORATE TRAVEL SHOW
    public void ProjectListTable()
    {
        try{
            String sql="SELECT EMPLOYEE.Emp_ID,Emp_Name,Project_Name,Project_NO,Project_Leader_ID,Foreign_Company,Destination,From_Date,To_Date,Cost_Amount,Emp_Email,Emp_PhoneNo FROM EMPLOYEE,CORPORATE_TRAVEL WHERE EMPLOYEE.Emp_ID=CORPORATE_TRAVEL.Emp_ID";
        ...
        }catch(Exception ex)
        {
            ...
            System.out.println("EMPLOYEE CORPORATE TRAVEL INFORMATION: "+ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1166, 596));
