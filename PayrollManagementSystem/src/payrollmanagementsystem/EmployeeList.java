...
public class EmployeeList extends javax.swing.JFrame {
    ...
    {
        try{
            String sql="select Emp_ID,Emp_Dept,Emp_Name,Emp_DOB,Emp_Age,Emp_Gender,Emp_Religion,Emp_Doj,Emp_Address,Emp_City,Emp_Nationality,Emp_Email,Emp_PhoneNo From EMPLOYEE";
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1216, 579));
